...
pt1 = torch.load(f'type10/checkpoints/{level}/1/epoch_9.pt')
pt2 = torch.load(f'type10/checkpoints/{level}/2_1/epoch_9.pt')
pt3 = torch.load(f'type10/checkpoints/{level}/2_2/epoch_9.pt')
pt4 = torch.load(f'type10/checkpoints/{level}/2_3/epoch_9.pt')
pt5 = torch.load(f'type10/checkpoints/{level}/2_4/epoch_9.pt')
pt6 = torch.load(f'type10/checkpoints/{level}/2_5/epoch_9.pt')
pt7 = torch.load(f'type10/checkpoints/{level}/2_6/epoch_9.pt')
...
test_xn = np.concatenate([test_text, test_parents, test_siblings, test_key], axis=1)
...
with open(f'type10/logfiles/{level}/results.txt','a') as log:
