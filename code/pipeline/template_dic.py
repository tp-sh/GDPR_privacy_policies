template_dict = {'1': 'Our contact details. Name: Address: Phone Number: E-mail:', 
...
''', 
                          '41': '''The type of personal information we collect 
We currently collect and process the following information:
Personal identifiers, contacts and characteristics (for example, name and contact details)
''', 
                          '47': '''How we get the personal information and why we have it
...
''', 
                          '54': '''Under the General Data Protection Regulation (GDPR), the lawful bases we rely on for processing this information are: [delete as appropriate]
...
(f) We have a legitimate interest.''', 
                          '64': '''We use the information that you have given us in order to [list how you use the personal information].''', 
                          '86': '''How we store your personal information 
...
We keep [type of personal information] for [time period]. We will then dispose your information by [explain how you will delete their data].''', 
                          '90': '''We may share your information with [enter organisations or individuals].'''}
