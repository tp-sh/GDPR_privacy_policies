...
- `complete_classifier_results.csv`: This file presents the results(f1 values) of 12 types of classifiers (as defined in our paper) on our corpus for each label at both the segment and document level under 5-fold cross validation.
